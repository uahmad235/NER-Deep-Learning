...
from .Trainer import *
from .MyModel import *
from .Tagger import predict, build_custom_response, _build_response
	...
	** from converting text data into sequences of integers
	...
	def analyze(self, text, trained = False):
		...
		if NERTagger.is_already_trained():
			...
			model.load_weights("./NER/saved/My_Custom_Model3.h5")
...
# if __name__ ==  "__main__":
	...
	# try:
	# NERTagger().train("./NER/data/ner_dataset.csv")
	# import sys
	# text = sys.argv[1]
